...
\usetikzlibrary{decorations.pathreplacing} % Add the decorations.pathreplacing library
...
\begin{tikzpicture}[scale=1.25]
  ...
  \draw[blue, thick] (2,3.4) node[above,black,above=5pt] {$x_k$} -- (3,4.2) node[above,black,above=5pt] {$e^{-i \Delta t H(u_k)} x_k$};
  ...
  \draw[decorate,decoration={brace,amplitude=3pt},xshift=4pt, line width=0.7pt] (3,4.2) -- (3,3.6) node[pos=0.5,black,right=4pt] {$f(x_{k+1}, x_k, u_k) = x_{k+1} - e^{-i \Delta t H(u_k)} x_k$};
